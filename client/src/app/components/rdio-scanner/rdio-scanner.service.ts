            ...
            switch (message[0]) {
                ...
                case WebsocketCommand.Config: {
                    ...
                    this.config = {
                        ...
                        dualLed: typeof config.dualLed === 'boolean' ? config.dualLed : false,
                        wigWagLed: typeof config.wigWagLed === 'boolean' ? config.wigWagLed : false,
                        email: typeof config.email === 'string' ? config.email : '',
                        groups: config.groups !== null && typeof config.groups === 'object' ? config.groups : {},
                        ...
                        tags: config.tags !== null && typeof config.tags === 'object' ? config.tags : {},
